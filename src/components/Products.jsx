...
const products = [
    { id: 1, title: '잘림 방지 장갑', image: '/assets/products/glove_cut_resistant.png' },
    { id: 2, title: 'nbr장갑/다용도장갑', image: '/assets/products/glove_nbr.png' },
    { id: 3, title: 'PU장갑', image: '/assets/products/glove_pu.png' },
    { id: 4, title: '카본장갑', image: '/assets/products/glove_carbon.png' },
    { id: 5, title: '내화학 장갑', image: '/assets/products/glove_chemical.png' },
    { id: 6, title: '타격/진동/찔림 방지 장갑', image: '/assets/products/glove_impact.png' },
];
                    ...
                    {products.map((product, index) => (
                        ...
                        >
                            ...
                            <div className="absolute bottom-0 left-0 p-4 md:p-8 w-full flex flex-col items-center text-center">
                                <h3 className="text-[31px] font-bold text-white mb-4 tracking-tighter">{product.title}</h3>
